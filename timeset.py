...
def detect():
    ...
    parser.add_argument('--save_to_system',
                        default='C:/Users/Lenovo/Desktop/Weed-detection/Video-Viewer_backend/app/static/images/picture',
    ...
    if not os.path.exists(save_to_system):
        os.makedirs(save_to_system)
    if os.path.exists(save_to_system):
        shutil.rmtree(save_to_system)
    shutil.copytree(save_dir, save_to_system)
